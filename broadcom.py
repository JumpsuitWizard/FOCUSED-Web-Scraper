...
def scrape_dependencies():
    ...
    elements = soup.select('[id="concept.dita_7dbb24920dfa3a5dce2a5f99db97517299650986_KeyFeatures14.4"] .ul .li div')
    ...
    for package in elements:
        ...
        version_match = re.search(r"(\bv?\d+(\.\d+)*\b)", package_text, re.IGNORECASE)
        if version_match:
